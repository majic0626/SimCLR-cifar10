...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(planes, momentum=norm_moment)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
        self.bn2 = norm_layer(planes, momentum=norm_moment)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(width, momentum=norm_moment)
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.bn2 = norm_layer(width, momentum=norm_moment)
        self.conv3 = conv1x1(width, planes * self.expansion)
        self.bn3 = norm_layer(planes * self.expansion, momentum=norm_moment)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
...
class Projector(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, norm_moment=0.9):
        ...
        self.project_layer = nn.Sequential(
            ...
            nn.BatchNorm1d(hidden_size, momentum=norm_moment),
